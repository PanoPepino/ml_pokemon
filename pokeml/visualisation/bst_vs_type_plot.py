...
def type_deviations_plot(stage,
                         rarity='regular',
    ...
    if len(available_constructions) == 0:
        print(f"ERROR: No data for {stage}/{rarity}")
        return
    ...
    ax.set_title(f'Stage: {stage} | Rarity: {rarity} | Median: {my_baseline}',
    ...
    fig.savefig(plot_path + f'stage_{stage}_type_dist.png', dpi=500, bbox_inches='tight')
